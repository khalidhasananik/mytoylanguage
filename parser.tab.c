...
static const char *const yytname[] =
{
  ...
  "EOL", "ADD", "SUB", "MUL", "DIV", "ASSIGN", "PRINT", "$accept",
...
{
       2,    11,     7,     8,     3,    14,    15,    16,    17,    18,
      19,     4,    12,    13,    14,    15,    10,     6
};

static const yytype_int8 yycheck[] =
{
       0,     6,     3,     4,     4,     8,     9,    12,    13,    14,
      15,    11,     6,     7,     8,     9,     5,    10
};
...
{
       0,    13,     0,     4,    11,    14,    10,     3,     4,    15,
       5,    15,     6,     7,     8,     9,    15,    15,    15,    15
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* program: program statement EOL  */
#line 48 "parser.y"
                            { }
#line 1095 "parser.tab.c"
    break;

  case 4: /* statement: IDENTIFIER ASSIGN expression  */
#line 52 "parser.y"
                                   { symbol_table[(yyvsp[-2].str)] = (yyvsp[0].num); std::cout << (yyvsp[-2].str) << " = " << symbol_table[(yyvsp[-2].str)] << std::endl; }
...
#line 58 "parser.y"
                                 { 
                                    if (symbol_table.find((yyvsp[0].str)) != symbol_table.end()) {
                                        (yyval.num) = symbol_table[(yyvsp[0].str)]; 
                                    } else {
...
#line 68 "parser.y"
                                 { if ((yyvsp[0].num)) (yyval.num) = (yyvsp[-2].num) / (yyvsp[0].num); else yyerror("Division by zero."); }
